...
def check_vram():
    """Check available VRAM and return in MB"""
...
def load_stable_diffusion(args):
    ...
    if loaded_vram > 3800:
        ...
        print("Try using --lowvram or --precision 4bit")
        sys.exit(1)
...
def load_stable_cascade(args):
    ...
    if loaded_vram > 3800:
        print(f"ERROR: VRAM usage too high ({loaded_vram:.0f}MB > 3800MB)")
        print("Try using --lite for Stable Cascade Lite")
        sys.exit(1)
